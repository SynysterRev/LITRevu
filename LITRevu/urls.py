...
urlpatterns = [
    ...
    path('ticket/<int:ticket_id>/review/create/', review.views.review_answer_create, name='review_answer_create'),
    ...
    path('update-profile-picture/', authentication.views.update_profile_picture, name='update_profile_picture'),
